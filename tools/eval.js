...
const IN_DOMAIN = [
  ...
  { q: '怎么确诊？要做哪些检查？', expect: ['HB-103', 'HB-003', 'HB-215', 'HB-218'] },
  { q: 'PRETEXT 分期是什么意思？', expect: ['HB-105', 'HB-221', 'HB-222', 'HB-224'] },
  { q: '化疗有什么副作用？怎么缓解？', expect: ['HB-111', 'HB-007'] },
  { q: '什么情况下需要做肝移植？', expect: ['HB-109'] },
  { q: '出院后多久复查一次？', expect: ['HB-110', 'HB-006', 'HB-240', 'HB-241'] },
  { q: 'AFP 是什么？为什么一直要查？', expect: ['HB-110', 'LAB-AFP', 'HB-009', 'HB-216', 'HB-217'] },
  ...
  // —— 深度知识库（hb_deep_kb，HB-264~323）新增题目 ——
  { q: '肝母细胞瘤和Wnt基因通路有关吗？', expect: ['HB-272'] },
  { q: 'CHIC风险分层是什么意思？', expect: ['HB-293'] },
  { q: '顺铂伤耳朵，有什么保护办法？', expect: ['HB-299'] },
  { q: '现在有肝母细胞瘤的靶向药吗？', expect: ['HB-310'] },
  { q: '孩子肝上长东西还可能是什么病？', expect: ['HB-308'] },
  { q: '混合上皮间叶型是什么意思？', expect: ['HB-281'] },
  { q: 'AFP特别低反而不好吗？', expect: ['HB-287', 'HB-288'] },
  { q: '肝移植前要满足什么条件？', expect: ['HB-301'] },
  { q: '肝母细胞瘤会遗传吗？生二胎要检查吗？', expect: ['HB-206', 'HB-322'] },
  { q: '肿瘤破裂还有救吗？', expect: ['HB-304'] },
];
