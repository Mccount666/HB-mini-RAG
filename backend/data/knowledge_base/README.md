...
| `web_collected.json` | 联网素材审核拆分问答对（63 条，HB-201~263） | 疾病科普/遗传/诊断/治疗/随访/… | 文本问答知识库，溯源见 `web_collected.mapping.md` |
| `hb_deep_kb.json` | 用户整理知识库（带出处）拆分问答对（60 条，HB-264~323） | 疾病科普/分子机制/病理/分期/治疗/随访/… | 深度知识库，溯源见 `hb_deep_kb.mapping.md` |
